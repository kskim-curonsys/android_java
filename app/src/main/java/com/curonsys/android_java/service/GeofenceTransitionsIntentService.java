...
import com.curonsys.android_java.activity.ARCameraActivity;
...
public class GeofenceTransitionsIntentService extends IntentService {
    ...
    private void sendNotification(String notificationDetails) {
        ...
        Intent notificationIntent = new Intent(getApplicationContext(), ARCameraActivity.class);    // ChooseActivity
